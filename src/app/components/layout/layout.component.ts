...
import { Menu, MenuService, SpinnerService } from '@src/app/services';
...
@Component({
	...
	template: `
		<div [nbSpinner]="spinner" nbSpinnerMessage="Carregando.." nbSpinnerSize="giant" nbSpinnerStatus="primary">
